# Test: Breadcrumb Navigation from Service Detail Back to Institution
...
## Description
Verify that the breadcrumb institution link on a service detail page navigates to the institution/entity page.
