# Test: Tab Switching - FAQ Tab Navigates to Support Page
...
## Description
Verify that clicking the "Tez-tez verilən suallar" (FAQ) tab on the service detail page triggers navigation to the support page (observed behavior).
