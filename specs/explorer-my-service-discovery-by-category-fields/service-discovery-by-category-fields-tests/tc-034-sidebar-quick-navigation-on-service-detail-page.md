# Test: Sidebar Quick Navigation on Service Detail Page
...
## Description
Verify that the sidebar on the service detail page contains a "MÜRACİƏT ET" button and a navigation list with "Xidmətin təsviri" entry.

## Preconditions
- Browser on a service detail page (desktop viewport).
