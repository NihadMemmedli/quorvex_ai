# Test: Regulation Document Link Points to External Resource
...
## Description
Verify that services with active regulation document buttons link to valid external resources (e.g., huquqiaktlar.gov.az or edu.gov.az).
