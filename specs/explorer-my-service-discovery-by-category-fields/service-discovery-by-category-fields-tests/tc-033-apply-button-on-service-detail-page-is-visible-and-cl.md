# Test: Apply Button on Service Detail Page Is Visible and Clickable
...
## Description
Verify that the "MÜRACİƏT ET" (Apply) button on the service detail page is visible, not disabled, and attempts to initiate the application flow (likely requiring authentication).

## Preconditions
- Browser on a service detail page. Not authenticated.
