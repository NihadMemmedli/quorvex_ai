# Test: Service Detail Tabs - Xidmətin Təsviri Tab Is Default
...
## Description
Verify that the service detail page loads with the "Xidmətin təsviri" (Service description) tab selected by default.
