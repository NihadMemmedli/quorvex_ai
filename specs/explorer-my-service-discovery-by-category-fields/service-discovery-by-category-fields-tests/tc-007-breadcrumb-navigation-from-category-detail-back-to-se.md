# Test: Breadcrumb Navigation from Category Detail Back to Services
...
## Description
Verify that the breadcrumb "Xidmətlər" link on a category detail page navigates back to the services listing page.

## Preconditions
- Browser on a category detail page (e.g., Təhsil).
