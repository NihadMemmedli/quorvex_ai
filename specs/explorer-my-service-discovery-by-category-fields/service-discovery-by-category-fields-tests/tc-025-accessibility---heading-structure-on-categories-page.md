# Test: Accessibility - Heading Structure on Categories Page
...
## Description
Verify the heading hierarchy on the service categories page follows accessibility best practices.
...
2. Verify the page has a heading structure: | h6 "Xidmətlər" as the main page heading | h2 headings in the footer ("Ana səhifə", "Xidmətlər", "Resurslar", "Media")
