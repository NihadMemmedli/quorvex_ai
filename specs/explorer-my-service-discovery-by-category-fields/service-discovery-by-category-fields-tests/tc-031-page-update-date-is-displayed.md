# Test: Page Update Date Is Displayed
...
## Description
Verify that each category page and service detail page displays the "Səhifənin son yenilənmə tarixi" (Last page update date) at the bottom of the content area.
