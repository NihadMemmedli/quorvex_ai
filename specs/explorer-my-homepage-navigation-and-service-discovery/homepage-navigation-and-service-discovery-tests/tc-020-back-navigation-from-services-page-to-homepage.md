# Test: Back Navigation from Services Page to Homepage
...
## Description
Verify that the browser back button correctly navigates from the services catalog page back to the homepage.

## Preconditions
- Browser session starting at https://my.gov.az/.
