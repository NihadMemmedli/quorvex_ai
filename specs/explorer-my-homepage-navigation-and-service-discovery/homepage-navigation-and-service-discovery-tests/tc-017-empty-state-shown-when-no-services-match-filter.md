# Test: Empty State Shown When No Services Match Filter
...
## Description
Verify that if a filter returns no services, an appropriate empty state message is displayed.

## Preconditions
- Browser navigated to https://my.gov.az/az/services. A search field is present.
