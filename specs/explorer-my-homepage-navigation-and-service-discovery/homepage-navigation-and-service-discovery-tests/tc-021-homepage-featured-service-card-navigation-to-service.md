# Test: Homepage Featured Service Card Navigation to Service Detail
...
## Description
Verify that clicking a featured service card on the homepage navigates to the correct service detail or application page.

## Preconditions
- Browser navigated to https://my.gov.az/. At least one featured service card is visible.
