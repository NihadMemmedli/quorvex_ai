# Test: Language Toggle Switches Page Language from Azerbaijani to Russian
...
## Description
Verify that clicking the Russian language option switches the page content to Russian.

## Preconditions
- Browser navigated to https://my.gov.az/. Page is in Azerbaijani (AZ) by default.
