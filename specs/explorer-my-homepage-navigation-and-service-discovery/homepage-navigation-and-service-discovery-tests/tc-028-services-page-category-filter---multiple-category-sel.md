# Test: Services Page Category Filter - Multiple Category Selection Behavior
...
## Description
Verify the behavior when the user selects multiple categories on the services catalog page.

## Preconditions
- Browser navigated to https://my.gov.az/az/services. At least 2 categories are visible.
