# Test: Language Toggle on Services Page Keeps User on Services Page
...
## Description
Verify that switching language on the services catalog page does not redirect the user to the homepage.

## Preconditions
- Browser navigated to https://my.gov.az/az/services.
