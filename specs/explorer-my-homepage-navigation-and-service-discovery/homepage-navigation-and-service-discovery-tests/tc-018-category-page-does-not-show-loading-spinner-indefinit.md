# Test: Category Page Does Not Show Loading Spinner Indefinitely on API Error
...
## Description
Verify that if the services API is slow or fails, the page does not display an indefinite loading spinner.

## Preconditions
- Browser navigated to https://my.gov.az/az/services. Network throttling may be required.
