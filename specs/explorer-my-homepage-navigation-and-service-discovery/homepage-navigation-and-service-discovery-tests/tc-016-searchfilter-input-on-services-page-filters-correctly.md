# Test: Search/Filter Input on Services Page Filters Correctly
...
## Description
Verify that if a search or text filter input is present on the services catalog page, it correctly filters services by name.

## Preconditions
- Browser navigated to https://my.gov.az/az/services. A search input field is visible.
