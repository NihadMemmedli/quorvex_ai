# Test: Clicking "All Services" Navigates to Services Catalog Page
...
## Description
Verify that clicking the "All Services" link from the homepage navigates to https://my.gov.az/az/services.

## Preconditions
- Browser navigated to https://my.gov.az/. The "All Services" link is visible.
