...
const variantStyles: Record<string, React.CSSProperties> = {
    default: {
        ...
        border: 'none',
        transition: 'background-color 0.2s var(--ease-smooth), border-color 0.2s var(--ease-smooth), color 0.2s var(--ease-smooth), opacity 0.2s var(--ease-smooth), box-shadow 0.2s var(--ease-smooth)',
    },
    destructive: {
